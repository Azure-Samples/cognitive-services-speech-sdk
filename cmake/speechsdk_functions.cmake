...
function(CREATE_LINK_WITH_COPY_FAILOVER LINK_SOURCE LINK_TARGET_PATH LINK_TARGET_FILE_NAME )
  ...
  if(NOT ${linkResult} EQUAL 0)
    if(NOT EXISTS ${LINK_TARGET_PATH}${LINK_TARGET_FILE_NAME})
      message("Error ${linkResult} Could not generate symbolic link for ${LINK_TARGET_PATH}${LINK_TARGET_FILE_NAME} will copy file instead. This means that you will have to update ${LINK_TARGET_FILE_NAME} in ${CARBON_ROOT}/tests as well as every other place this file is copied. (If you run cmake as admin this won't happen)")
      file(COPY ${LINK_SOURCE} DESTINATION ${LINK_TARGET_PATH} FOLLOW_SYMLINK_CHAIN )
    endif()
  endif()
endfunction()
...
These samples demonstrate embedded and hybrid speech recognition and synthesis using the Speech SDK for C# (.NET Core).
...
See the [platform requirements for installing the Speech SDK](https://docs.microsoft.com/azure/cognitive-services/speech-service/quickstarts/setup-platform?pivots=programming-language-csharp).
...
* If using the command line:
  * [.NET 6.0](https://docs.microsoft.com/dotnet/core/install/) (dotnet)

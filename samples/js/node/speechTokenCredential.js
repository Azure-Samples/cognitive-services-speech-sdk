...
export const main = (settings) => {
  ...
  // Create SpeechConfig using the fromEndpoint method with DefaultAzureCredential
  ...
  var speechConfig = sdk.SpeechConfig.fromEndpoint(new URL(settings.serviceEndpoint), credential);

...
export const main = (settings) => {
  ...
  // Create SpeechConfig using the fromEndpoint method with AzureKeyCredential
  var speechConfig = sdk.SpeechConfig.fromEndpoint(new URL(settings.serviceEndpoint), keyCredential);

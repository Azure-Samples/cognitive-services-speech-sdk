...
translate_parser.add_argument('--video_file_blob_url', required = False, type=str, help='Video file blob url for video translation.')
translate_parser.add_argument('--audio_file_blob_url', required = False, type=str, help='Audio file blob url for video translation.')
translate_parser.add_argument('--source_locale', required = False, type=str, help='Source locale of the video file.')
...
translate_parser.add_argument('--enable_lip_sync', required = False, type=str, help='Indicate whether enable lip sync.')
translate_parser.add_argument('--enable_emotional_platform_voice', required = False, type=str, help='Indicate whether enable emotional platform voice.')
...
translate_parser.add_argument('--tts_custom_lexicon_file_url', required = False, type=str, help='Translate with TTS custom lexicon for TTS synthesis, provide the custom lexicon file with URL, ttsCustomLexiconFileUrl and ttsCustomLexiconFileIdInAudioContentCreation are conflict, only one of them are required.')
translate_parser.add_argument('--tts_custom_lexicon_file_id_in_audio_content_creation', required = False, type=str, help='Translate with TTS custom lexicon for TTS synthesis, provide the custom lexicon file with file ID in Audio Content Creation, ttsCustomLexiconFileUrl and ttsCustomLexiconFileIdInAudioContentCreation are conflict, only one of them are required.')
translate_parser.add_argument('--enable_video_speed_adjustment', required = False, type=bool, help='This parameter allows for the adjustment of video playback speed to ensure better alignment with translated audio. When enabled, the API can slow down or speed up the video to match the timing of the translated audio, providing a more synchronized and seamless viewing experience.')
translate_parser.add_argument('--enable_ocr_correction_from_subtitle', required = False, type=bool, help='Indicate whether allow the API to correct the speech recognition (SR) results using the subtitles from the original video file. By leveraging the existing subtitles, the API can enhance the accuracy of the transcribed text, ensuring that the final output is more precise and reliable.')
translate_parser.add_argument('--export_target_locale_advanced_subtitle_file', required = False, type=bool, help='This parameter, when enabled, allows the API to export subtitles in the Advanced SubStation Alpha format. The subtitle file can specify font styles and colors, which helps in addressing character display issues in certain target locales such as Arabic (Ar), Japanese (Ja), Korean (Ko), and Chinese (Ch). By using this parameter, you can ensure that the subtitles are visually appealing and correctly rendered across different languages and regions.')
translate_parser.add_argument('--subtitle_primary_color', required = False, type=str, help='This parameter specifies the primary color of the subtitles in the video translation output. The value should be provided in the format <rr><gg><bb>, #<rr><gg><bb>, <rr><gg><bb><aa> or #<rr><gg><bb><aa>, where <rr> represents the red component of the color, <gg> represents the green component, <bb> represents the blue component, <aa> represents the alpha component. For example, EBA205 or #EBA205  would set the subtitle color to a specific shade of yellow. This parameter allows for customization of subtitle appearance to enhance readability and visual appeal.')
translate_parser.add_argument('--subtitle_outline_color', required = False, type=str, help='This parameter specifies the outline color of the subtitles in the video translation output. The value should be provided in the format <rr><gg><bb>, #<rr><gg><bb>, <rr><gg><bb><aa> or #<rr><gg><bb><aa>, where <rr> represents the red component of the color, <gg> represents the green component, <bb> represents the blue component, <aa> represents the alpha component. For example, EBA205 or #EBA205  would set the subtitle color to a specific shade of yellow. This parameter allows for customization of subtitle appearance to enhance readability and visual appeal.')
translate_parser.add_argument('--subtitle_font_size', required = False, type=int, help='This parameter specifies the font size of subtitles in the video translation output.')

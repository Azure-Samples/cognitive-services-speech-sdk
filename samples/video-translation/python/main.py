...
translate_parser = sub_parsers.add_parser('create_translation_and_iteration_and_wait_until_terminated',
                                          help='Create translation with video file blob url, '
                                               'and create first iteration for the translation.')
...
translate_parser.add_argument('--voice_kind', required=True, type=str,
                              help='Voice kind used for TTS synthesizing, value can be one of: PlatformVoice or PersonalVoice.')
translate_parser.add_argument('--speaker_count', required=False, type=int,
                              help='Speaker count of the video, optional, auto detect if not provided.')
translate_parser.add_argument('--subtitle_max_char_count_per_segment', required=False, type=int,
                              help='Subtitle max char count per segment, optional.')
translate_parser.add_argument('--export_subtitle_in_video', required=False, type=bool,
                              help='Whether export subtitle in translated video, optional, False by default.')
translate_parser.set_defaults(func=handle_create_translation_and_iteration_and_wait_until_terminated)

translate_parser = sub_parsers.add_parser('create_iteration_with_webvtt_and_wait_until_terminated',
...
translate_parser.add_argument('--webvtt_file_kind', required=True, type=str,
                              help='Webvtt file kind, one of: MetadataJson, SourceLocaleSubtitle, TargetLocaleSubtitle')
...
translate_parser.add_argument('--webvtt_file_kind', required=False, type=str,
                              help='Webvtt file kind, one of: MetadataJson, SourceLocaleSubtitle, TargetLocaleSubtitle.')
translate_parser.add_argument('--speaker_count', required=False, type=int,
                              help='Speaker count of the video, optional, auto detect if not provided.')
translate_parser.add_argument('--subtitle_max_char_count_per_segment', required=False, type=int,

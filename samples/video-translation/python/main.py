...
ARGUMENT_HELP_VIDEO_FILE_BLOB_URL = ('Translation video file url, .mp4 file format, maxmum 5GB file size and 4 hours video duration. '
...
ARGUMENT_HELP_AUDIO_FILE_BLOB_URL = ('Translation audio file url, .mp3 or .wav file format, maxmum 5GB file size and 4 hours video duration. '
    'Provide the input media file using either videoFileUrl or audioFileUrl, these parameters are '
    'mutually exclusive—only one of them is required. If both are provided, the request will be considered invalid.'
)
ARGUMENT_HELP_SOURCE_LOCALE = ('The source locale of the video file. Locale code follows BCP-47. You can find the text to speech locale list '
...
ARGUMENT_HELP_TARGET_LOCALE = 'The target locale of the translation. Locale code follows BCP-47. You can find the text to speech locale list '\
...
ARGUMENT_HELP_ENABLE_LIP_SYNC = 'Indicate whether to enable lip sync, if not provided, the default value is false to disable the lip sync.'
...
ARGUMENT_HELP_SUBTITLE_MAX_CHAR_COUNT_PER_SEGMENT = 'Subtitle max display character count per segment, if not provided, it will use the language dependent default value.'
ARGUMENT_HELP_EXPORT_SUBTITLE_IN_VIDEO = 'Export subtitle in video, if not specified, the default value is false, it will not burn subtitle to the translated video file.'
...
ARGUMENT_HELP_SUBTITLE_PRIMARY_COLOR = (
    ...
    'where <rr> represents the red component of the color, <gg> represents the green component, <bb> represents the blue component, <aa> represents the alpha component. '
    'For example, EBA205 or #EBA205 would set the subtitle color to a specific shade of yellow. This parameter allows for customization '
    'of subtitle appearance to enhance readability and visual appeal.'
)
...
ARGUMENT_HELP_WEBVTT_FILE_KIND = (
    'Webvtt file kind for content editing, this parameter is required from the second iteration creation request of the translation, '
    'one of: MetadataJson, SourceLocaleSubtitle, TargetLocaleSubtitle.'
)
ARGUMENT_HELP_WEBVTT_FILE_BLOB_URL = (
    'Webvtt file blob url for content editing, this parameter is required from the second iteration creation request of the translation.'
)
...
translate_parser.add_argument('--enable_emotional_platform_voice', required=False, type=str, help=ARGUMENT_HELP_ENABLE_EMOTIONAL_PLATFORM_VOICE)
translate_parser.add_argument('--speaker_count', required=False, type=int, help=ARGUMENT_HELP_SPEAKER_COUNT)
translate_parser.add_argument('--subtitle_max_char_count_per_segment', required=False, type=int, help=ARGUMENT_HELP_SUBTITLE_MAX_CHAR_COUNT_PER_SEGMENT)
...
translate_parser.add_argument('--tts_custom_lexicon_file_url', required=False, type=str, help=ARGUMENT_HELP_TTS_CUSTOM_LEXICON_FILE_URL)
...
translate_parser.add_argument('--enable_video_speed_adjustment', required=False, type=bool, help=ARGUMENT_HELP_ENABLE_VIDEO_SPEED_ADJUSTMENT)
...
translate_parser.add_argument('--translation_id', required=True, type=str,
    help='Translation ID.'
)
...
translate_parser.add_argument('--export_subtitle_in_video', required=False, type=bool, help=ARGUMENT_HELP_EXPORT_SUBTITLE_IN_VIDEO)
translate_parser.add_argument('--tts_custom_lexicon_file_url', required=False, type=str, help=ARGUMENT_HELP_TTS_CUSTOM_LEXICON_FILE_URL)
translate_parser.add_argument('--tts_custom_lexicon_file_id_in_audio_content_creation', required=False, type=str, help=ARGUMENT_HELP_TTS_CUSTOM_LEXICON_FILE_ID_IN_AUDIO_CONTENT_CREATION)
translate_parser.add_argument('--enable_video_speed_adjustment', required=False, type=bool, help=ARGUMENT_HELP_ENABLE_VIDEO_SPEED_ADJUSTMENT)
translate_parser.add_argument('--enable_ocr_correction_from_subtitle', required=False, type=bool, help=ARGUMENT_HELP_ENABLE_OCR_CORRECTION_FROM_SUBTITLE)
translate_parser.add_argument('--export_target_locale_advanced_subtitle_file', required=False, type=bool, help=ARGUMENT_HELP_EXPORT_TARGET_LOCALE_ADVANCED_SUBTITLE_FILE)
translate_parser.add_argument('--subtitle_primary_color', required=False, type=str, help=ARGUMENT_HELP_SUBTITLE_PRIMARY_COLOR)
translate_parser.add_argument('--subtitle_outline_color', required=False, type=str, help=ARGUMENT_HELP_SUBTITLE_OUTLINE_COLOR)
translate_parser.add_argument('--subtitle_font_size', required=False, type=int, help=ARGUMENT_HELP_SUBTITLE_FONT_SIZE)

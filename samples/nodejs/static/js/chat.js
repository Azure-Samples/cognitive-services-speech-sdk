...
function createSpeechRecognizer() {
    ...
    .then(response => {
        if (response.ok) {
            ...
            const speechKey = response.headers.get('SpeechKey')
            ...
            response.text().then(text => {
                ...
                const speechRecognitionConfig = speechPrivateEndpoint ?
                    ...
                    SpeechSDK.SpeechConfig.fromEndpoint(new URL(`wss://${speechRegion}.stt.speech.microsoft.com/speech/universal/v2`), speechKey)

...
=======
            ...
            "useBuiltInVoice": False,  # whether to use voice sync of custom avatar. Only valid if customized is True and the custom avatar is trained with voice sync enabled.
>>>>>>> de37d3d76 (Update python sample)
        }
    }

...
public class SubscriptionsRegionsKeys
{
    public static final String UNIFIED_SPEECH_SUBSCRIPTION = "UnifiedSpeechSubscription";
    public static final String DIALOG_SUBSCRIPTION = "DialogSubscription";

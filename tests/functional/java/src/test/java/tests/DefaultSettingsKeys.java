...
public class DefaultSettingsKeys
{
    public static final String ENDPOINT = "Endpoint";
    public static final String DIALOG_FUNCTIONAL_TEST_BOT = "DialogFunctionalTestBot";
    public static final String LANGUAGE_UNDERSTANDING_HOME_AUTOMATION_APP_ID = "LanguageUnderstandingHomeAutomationAppId";
    public static final String INROOM_AUDIO_ENDPOINT = "InRoomAudioEndpoint";
    public static final String CONVERSATION_TRANSCRIPTION_ENDPOINT = "ConversationTranscriptionEndpoint";

...
public class TranslationSynthesisResult
{
    ...
    TranslationSynthesisResult(Carbon.Internal.TranslationSynthesisResult result)
    {
        _AudioData = null; // TODO result.getAudioData();
    }

    public TranslationSynthesisResult(Carbon.Recognition.Translation.TranslationSynthesisResult result) {

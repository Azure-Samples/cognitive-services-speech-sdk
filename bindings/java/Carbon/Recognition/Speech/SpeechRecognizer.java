...
/// </code>
/// </example>
public final class SpeechRecognizer extends Carbon.Recognition.Recognizer
{
    /// <summary>
    ...
    public SpeechRecognizer(Carbon.Internal.SpeechRecognizer recoImpl) throws UnsupportedOperationException
    {
    ...
    public Carbon.Internal.SpeechRecognizer getRecoImpl() {
        return recoImpl;
    }

    private Carbon.Internal.SpeechRecognizer recoImpl;
    ...
    private class ResultHandlerImpl extends Carbon.Internal.SpeechRecognitionEventListener
    {
        ...
        @Override
        public void execute(Carbon.Internal.SpeechRecognitionEventArgs eventArgs)
        {
    ...
    private class ErrorHandlerImpl extends Carbon.Internal.SpeechRecognitionEventListener
    {

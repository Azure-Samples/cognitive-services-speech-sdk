...
public final class ParameterCollection<OwnerType> implements Closeable
{
    ...
    {
        if (owner.getClass().equals(Carbon.Recognition.RecognizerFactory.class))
        {
            isFactoryParameter = true;
            speechParameters = null;
        }
        else if (owner.getClass().equals(Carbon.Recognition.Speech.SpeechRecognizer.class))
        {
            isFactoryParameter = false;
            Carbon.Recognition.Speech.SpeechRecognizer speechRecognizer = (Carbon.Recognition.Speech.SpeechRecognizer)owner;
    ...
    {
        return false; //isFactoryParameter ? Carbon.Internal.DefaultRecognizerFactory.Parameters.containsString(name) : speechParameters.containsString(name);
    }
    public boolean isInt(String name)
    {
        return false; //isFactoryParameter ? Carbon.Internal.DefaultRecognizerFactory.Parameters.containsNumber(name) : speechParameters.containsNumber(name);
    }
    public boolean isBool(String name)
    {
        return false; //isFactoryParameter ? Carbon.Internal.DefaultRecognizerFactory.Parameters.containsBool(name) : speechParameters.containsBool(name);
    }
    ...
    {
        String ret = isFactoryParameter ? Carbon.Internal.DefaultRecognizerFactory.Parameters.getString(name, defaultValue) : speechParameters.getString(name, defaultValue);
        return ret;
    }
    public int getInt(String name, int defaultValue)
    {
        int ret = isFactoryParameter ? Carbon.Internal.DefaultRecognizerFactory.Parameters.getNumber(name, defaultValue) : speechParameters.getNumber(name, defaultValue);
        return ret;
    }
    public boolean getBool(String name, boolean defaultValue)
    {
        boolean ret = isFactoryParameter ? Carbon.Internal.DefaultRecognizerFactory.Parameters.getBool(name, defaultValue) : speechParameters.getBool(name, defaultValue);
        return ret;
    }

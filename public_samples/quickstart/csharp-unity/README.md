...
* Under **Project** > **Assets** > **SpeechSDK** > **Plugins** > **iOS**, check `Microsoft.CognitiveServices.Speech.csharp.dll` target enabled for Editor and iOS.
* Under **Project** > **Assets** > **SpeechSDK** > **Plugins** > **x86_64**, uncheck `Microsoft.CognitiveServices.Speech.csharp.dll` target for Editor.
* Open **File** > **Build Settings**,
...
* In Xcode, under **Targets** > **Unity-Phone** > **Build Settings**, check that `Bitcode` is set to false.

...
namespace MicrosoftSpeechSDKSamples.UwpSpeechSynthesisSample
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void SpeechSynthesisToSpeaker_ButtonClicked(object sender, RoutedEventArgs e)
        {
            ...
            using (var synthesizer = new SpeechSynthesizer(config))
            {
                ...
                using (var result = await synthesizer.SpeakTextAsync(this.TextForSynthesizingTextBox.Text).ConfigureAwait(false))
                {
                    ...
                    {
                        NotifyUser($"Speech Synthesis Failed. '{result.Reason.ToString()}'", NotifyType.ErrorMessage);
                    }
                    else
                    {
                ...
                // Sleep a while for the playback finishes
        ...
        private async void EnableAudioDevice_ButtonClicked(object sender, RoutedEventArgs e)
        {
            ...
            {
                NotifyUser("Audio device was enabled", NotifyType.StatusMessage);
            }
        }

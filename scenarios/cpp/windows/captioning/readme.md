...
> - If you install the 64-bit version of GStreamer, you must also [configure your C++ project to target 64-bit platforms](https://docs.microsoft.com/cpp/build/how-to-configure-visual-cpp-projects-to-target-64-bit-platforms?view=msvc-170).

        ...
        while (index < len(text)):
            ...
            if add_caption:
                ...
                if is_first_caption and is_last_caption:
                    ...
                    partial_timing_params = (result, text, caption_text, caption_starts_at, index - caption_starts_at)
                    caption_begin_and_end = self.get_partial_result_caption_timing(*partial_timing_params)

                self._captions.append(Caption(
                    self._language, caption_sequence, caption_begin_and_end[0], caption_begin_and_end[1], caption_text
                ))

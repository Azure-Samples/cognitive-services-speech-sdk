...
//
// speechapi_c_dialog_connector.h: Public API declaration for Dialog Connector related C methods.
//
...
SPXAPI dialog_connector_activity_received_event_get_activity(SPXEVENTHANDLE h_event, SPXACTIVITYHANDLE* p_activity);
SPXAPI_(bool) dialog_connector_activity_received_event_has_audio(SPXEVENTHANDLE h_event);
SPXAPI dialog_connector_activity_received_event_get_audio(SPXEVENTHANDLE h_event, SPXAUDIOSTREAMHANDLE* p_audio);
SPXAPI dialog_connector_recognized_size(SPXEVENTHANDLE h_event, uint32_t* size);
SPXAPI dialog_connector_recognized_get_result(SPXEVENTHANDLE h_event, uint32_t* size);

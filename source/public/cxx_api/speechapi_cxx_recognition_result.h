...
public:
    ...
    /// </summary>
    ResultPropertyValue(SPXRESULTHANDLE hresult, const std::string& name) : m_hresult(hresult), m_name(name) { }
    ...
    std::string GetString(const std::string& defaultValue) override { return GetString(m_hresult, m_name.c_str(), defaultValue); }

    /// <summary>
    /// Stores the specified string inside the encapsulated value.
    /// </summary>
    void SetString(const std::string& value) override { UNUSED(value); SPX_THROW_HR(SPXERR_NOT_IMPL); }
...
private:
    ...
    std::string PropertyNameFromEnum(ResultProperty property)
    {
    ...
    static std::string GetString(SPXRESULTHANDLE hresult, const std::string& name, const std::string& defaultValue)
    {
        const size_t maxCharCount = 4096;
        char sz[maxCharCount+1];
    ...
    static int32_t GetNumber(SPXRESULTHANDLE hresult, const std::string& name, int32_t defaultValue)
    {
        int32_t value;
    ...
    static bool GetBool(SPXRESULTHANDLE hresult, const std::string& name, bool defaultValue)
    {
        bool value;
    ...
    static bool ContainsString(SPXRESULTHANDLE hresult, const std::string& name)
    {
        return Result_ContainsProperty_String(hresult, name.c_str());
    }

    static bool ContainsNumber(SPXRESULTHANDLE hresult, const std::string& name)
    {
        return Result_ContainsProperty_Int32(hresult, name.c_str());
    }

    static bool ContainsBool(SPXRESULTHANDLE hresult, const std::string& name)
    {
...
public:
    ...
    Value operator[](const std::string& name) override { return Value(new ResultPropertyValue(m_handle, name)); }

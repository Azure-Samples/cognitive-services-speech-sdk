...
//
// speechapi_c_dialog_config.cpp: Public API definitions for dialog configuration related C methods and types
//
#include "stdafx.h"
...
SPXAPI dialog_config_from_bot_secret(SPXSPEECHCONFIGHANDLE* ph_dialog_config, const char* secret_key, const char *subscription, const char* region)
{
    SPX_RETURN_HR_IF(SPXERR_INVALID_ARG, ph_dialog_config == nullptr);
    SPX_RETURN_HR_IF(SPXERR_INVALID_ARG, secret_key == nullptr);
    SPX_RETURN_HR_IF(SPXERR_INVALID_ARG, subscription == nullptr);

    SPXAPI_INIT_HR_TRY(hr)
    {
        *ph_dialog_config = SPXHANDLE_INVALID;
        ...
        *ph_dialog_config = config_handles->TrackHandle(config);
    }
    SPXAPI_CATCH_AND_RETURN_HR(hr);
}

SPXAPI dialog_config_from_task_dialog_app_id(SPXSPEECHCONFIGHANDLE* ph_dialog_config, const char* app_id, const char *subscription, const char* region)
{
    SPX_RETURN_HR_IF(SPXERR_INVALID_ARG, ph_dialog_config == nullptr);

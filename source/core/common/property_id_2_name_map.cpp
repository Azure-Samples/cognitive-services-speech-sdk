...
const SpeechPropertyIdNameHash g_PropertyId2NameMap = {
    ...
    { SpeechPropertyId::SpeechServiceConnection_DeploymentId, "SPEECH-ModelId" },
    ...
    { SpeechPropertyId::SpeechServiceResponse_OutputFormat, "SPEECH-OutputFormat" },
    { SpeechPropertyId::SpeechServiceResponse_OutputFormat_Detailed, "DETAILED" },
    { SpeechPropertyId::SpeechServiceResponse_OutputFormat_Simple, "SIMPLE" },

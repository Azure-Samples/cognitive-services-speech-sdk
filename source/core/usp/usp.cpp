...
void Connection::SendMessage(const string& messagePath, const uint8_t* buffer, size_t size, MessageType messageType, const string& requestId, bool binary)
{
    m_impl->QueueMessage(messagePath, buffer, size, messageType, requestId, binary);
}

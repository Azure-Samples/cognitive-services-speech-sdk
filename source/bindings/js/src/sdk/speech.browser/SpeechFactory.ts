...
export class SpeechFactory {
     ...
     * @param audioConfig Specifies the audio input file.
     * @return A speech recognizer instance.
     */
    public createSpeechRecognizerFromConfig(audioConfig: AudioConfig): SpeechRecognizer {
        Contracts.throwIfDisposed(this.disposed);
        Contracts.throwIfNullOrUndefined(audioConfig, "audioConfig");

        return new SpeechRecognizer(this.parameters, audioConfig);
    }
     ...
     * @return A speech recognizer instance.
     */
    public createSpeechRecognizerFromConfigAndLanguage(audioConfig: AudioConfig, language: string): SpeechRecognizer {
        Contracts.throwIfDisposed(this.disposed);
        Contracts.throwIfNullOrUndefined(audioConfig, "audioConfig");
        Contracts.throwIfNullOrUndefined(language, "language");
        ...
        return new SpeechRecognizer(parameters, audioConfig);
    }
     ...
     * @return A speech recognizer instance.
     */
    public createSpeechRecognizerFromConfigAndLanguageAndOutput(audioConfig: AudioConfig, language: string, format: OutputFormat): SpeechRecognizer {
        Contracts.throwIfDisposed(this.disposed);
        Contracts.throwIfNullOrUndefined(audioConfig, "audioConfig");
        Contracts.throwIfNullOrUndefined(language, "language");
        Contracts.throwIfNullOrUndefined(format, "format");
     ...
     * @return An intent recognizer instance
     */
    public createIntentRecognizerWithFileInput(audioConfig: AudioConfig): IntentRecognizer {
        Contracts.throwIfDisposed(this.disposed);
        Contracts.throwIfNullOrUndefined(audioConfig, "audioConfig");

        return new IntentRecognizer(this.parameters, null);
    }
     ...
     * @return An intent recognizer instance
     */
    public createIntentRecognizerWithFileInputAndLanguage(audioConfig: AudioConfig, language: string): IntentRecognizer {
        Contracts.throwIfDisposed(this.disposed);
        Contracts.throwIfNullOrUndefined(audioConfig, "audioConfig");
        Contracts.throwIfNullOrUndefined(language, "language");
     ...
     * @param audioConfig Specifies the audio input file. Currently, only WAV / PCM with 16-bit samples, 16 KHz sample rate, and a single channel (Mono) is supported.
     * @param sourceLanguage The spoken language that needs to be translated.
     * @param targetLanguages The target languages of translation.
     * @return A translation recognizer instance.
     */
    public createTranslationRecognizerFromConfig(audioConfig: AudioConfig, sourceLanguage: string, targetLanguages: string[]): TranslationRecognizer {
        Contracts.throwIfDisposed(this.disposed);
        Contracts.throwIfNullOrUndefined(audioConfig, "audioConfig");
        Contracts.throwIfNullOrUndefined(sourceLanguage, "sourceLanguage");
        Contracts.throwIfArrayEmptyOrWhitespace(targetLanguages, "targetLanguages");
        ...
        return new TranslationRecognizer(parameters, audioConfig);
    }
     ...
     * @return A translation recognizer instance.
     */
    public createTranslationRecognizerFromConfigAndVoice(audioConfig: AudioConfig, sourceLanguage: string, targetLanguages: string[], voice: string): TranslationRecognizer {
        Contracts.throwIfDisposed(this.disposed);
        Contracts.throwIfNullOrUndefined(audioConfig, "audioConfig");
        Contracts.throwIfNullOrUndefined(sourceLanguage, "sourceLanguage");
        Contracts.throwIfArrayEmptyOrWhitespace(targetLanguages, "targetLanguages");

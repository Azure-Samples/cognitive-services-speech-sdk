...
namespace Microsoft.CognitiveServices.Speech.Dialog
{
    ...
    public sealed class DialogServiceConnector : IDisposable
    {
        ...
        /// </summary>
        public string SpeechActivityTemplate
        {
            get
            {
                return Properties.GetProperty(PropertyId.Conversation_Speech_Activity_Template);
            }
            ...
            set
            {
                ...
                Properties.SetProperty(PropertyId.Conversation_Speech_Activity_Template, value);
            }
        }

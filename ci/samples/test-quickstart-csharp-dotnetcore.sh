...
CSPROJ=public_samples/quickstart/csharp/dotnetcore/from-microphone/helloworld/helloworld.csproj
ASSEMBLY=public_samples/quickstart/csharp/dotnetcore/from-microphone/helloworld/bin/Debug/netcoreapp2.0/helloworld.dll

...
runXcodeTest() {
  ...
  xcodebuild test "${projectArg[@]}" \
    ...
    SPEECHSDK_SPEECH_KEY="$SPEECHSDK_SPEECH_KEY" SPEECHSDK_SPEECH_REGION="$SPEECHSDK_SPEECH_REGION" SPEECHSDK_PRINCETON_CONVERSATIONTRANSCRIBER_PPE_KEY="$SPEECHSDK_PRINCETON_CONVERSATIONTRANSCRIBER_PPE_KEY" \
